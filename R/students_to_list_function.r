...
#'
#' students.to.list(learn.rate=learn.rate, home.env=home.env, decay.rate=decay.rate, initial.ach=initial.ach,
#'                    which.curriculum=c(rep(1, times=length(learn.rate)/2), rep(2, times=length(learn.rate)/2)))
