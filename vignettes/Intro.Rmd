---
title: "ZPDGrowthTrajectories introduction"
author: "Matthew T. McBee"
date: "`r Sys.Date()`"
...
The package is available on the lead author's github site. To install the package, you will first need to download the ```devtools``` package.
